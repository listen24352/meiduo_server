...
def generic_detail_html(sku):
    ...
    # file_path = os.path.join(os.path.dirname(settings.BASE_DIR), '/home/ubuntu/shop/front/goods/%s.html' % sku.id)
    file_path = '/home/ubuntu/shop/front/goods/%s.html' % sku.id
